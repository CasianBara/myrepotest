...
1. You will find the source code of exercise 1 and the start of exercise 2 at `module-1-azure-architecture-introduction/src/Exercise_1`.
...
If you had trouble implementing the Circuit Breaker, you can use the provided solution instead. You should find it under `module-1-azure-architecture-introduction/src/Exercise_2`.
...
By pushing any change to the repository, it will trigger the deployment workflow of the web app. You can follow the deployment by going to the GitHub repo in your browser, and clicking the actions tab.
