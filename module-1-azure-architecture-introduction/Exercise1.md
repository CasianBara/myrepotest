...
Create your own repository in Github and add the solution provided in [ext_AdvancedAzureArchitecture](https://github.com/KeyTicket-Solutions/ext_AdvancedAzureArchitecture). After creating the repository, clone it onto your local machine.
...
At the end of this step you can open [Azure Portal](https://portal.azure.com/) and see your deployed resources: Bot Container API, Game Container API, Virtual Network, Container Apps Environment and a Cosmos DB
...
>[!NOTE]
>A Hostname is the URL without leading "https://"
...
```powershell
$ManagedEnvironment2="<second-managed-environment>"
   ```
...
You can find the endpoint in your Network Resource Group, in your Front Door resource, on the Overview tab, under Properties there will be the Endpoint hostname
...
```powershell
$OriginGroupName2="<second-origin-group-name>"
```
